...
try:
	prox= requests.get('https://github.com/Snk0012/Proxies.txt/new/main).text
...
android_models=[]
try:
	xx = requests.get('https://github.com/Snk0012/Proxies.txt/new/main').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/Snk0012/Proxies.txt/new/main').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
try:
	...
	if not os.path.exists('.n'):
		...
		os.system('https://github.com/Snk0012/Ap.txt/tree/main)
		exit()
def approval():
  os.system('clear')
  print(logo)
 ...
 #     print(" Easypaisa  Number     : +923118933642")
  #    print(" Trust Wallet Address : 0xb785952B2825366c8756fb65520F7Df8e0D145bD ")
      ...
      tks = ('Hello%20ULS-ADMIN&20Sir%20!%20Please%20Approve%20My%20Key%20The%20ULS%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+923437301353?text='+tks)
      time.sleep(1)
      approval()
  except:
    sys.exit()
